%global tarball xf86-input-elographics
...
%changelog
* Wed Nov 11 2015 Adam Jackson <ajax@redhat.com> - 1.4.1-4
...
* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 1.2.3-4.1
- Rebuilt for RHEL 6

* Mon Jul 27 2009 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.2.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_12_Mass_Rebuild

* Fri Jul 17 2009 Peter Hutterer <peter.hutterer@redhat.com> - 1.2.3-3
- elographics-1.2.3-abi.patch: Cope with XINPUT ABI 7.

* Wed Jul 15 2009 Adam Jackson <ajax@redhat.com> - 1.2.3-2.1
- ABI bump

* Thu Feb 26 2009 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.2.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_11_Mass_Rebuild

* Tue Oct 21 2008 Peter Hutterer <peter.hutterer@redhat.com> 1.2.3-1
- elographics 1.2.3
...
- Updated xorg-x11-drv-elographics to version 1.0.0.2 from X11R7 RC2
